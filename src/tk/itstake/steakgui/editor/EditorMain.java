...
public class EditorMain {
    public void show(Menu menu, Player p, String menuName) {
        ...
        EditorMainItem menusettingitem = new EditorMainItem(menu, menuName, p, 0, SteakGUI.convertMessage("&b매뉴 설정"), menusettingicon, lorearray);
        ...
        EditorMainItem menuitemedititem = new EditorMainItem(menu, menuName, p, 1, SteakGUI.convertMessage("&b매뉴 아이템 설정"), menuitemicon, lorearray2);
    ...
    class EditorMainItem extends MenuItem {
        ...
        public EditorMainItem(Menu lmenu, String menuName, Player p, int type, String displayName, ItemStack icon, String... lore) {
