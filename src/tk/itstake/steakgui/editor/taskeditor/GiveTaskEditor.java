...
public class GiveTaskEditor {
    public void show(Menu menu, Player player, String menuname, int slot, int task) {
        ...
        setting.setItem(0, new ItemTaskItem(menu, menuname, player, task, 0, 1,  slot, SteakGUI.convertMessage("&c펄미션 받기"), Material.PAPER, new String[]{SteakGUI.convertMessage("&b받는 물품을 펄미션으로 설정합니다.")}));
        setting.setItem(1, new ItemTaskItem(menu, menuname, player, task, 1, 1,  slot, SteakGUI.convertMessage("&c아이템 받기"), Material.EMERALD, new String[]{SteakGUI.convertMessage("&b받는 물품을 아이템으로 설정합니다.")}));
        setting.setItem(2, new ItemTaskItem(menu, menuname, player, task, 2, 1,  slot, SteakGUI.convertMessage("&c경험치 받기"), Material.ENCHANTMENT_TABLE, new String[]{SteakGUI.convertMessage("&b받는 물품을 경험치로 설정합니다.")}));
        setting.setItem(3, new ItemTaskItem(menu, menuname, player, task, 3, 1,  slot, SteakGUI.convertMessage("&c레벨 받기"), Material.EXP_BOTTLE, new String[]{SteakGUI.convertMessage("&b받는 물품을 레벨으로 설정합니다.")}));
        if(((String)edittask.getData()[0]).equals("permission")) {
            setting.setItem(9, new ItemTaskItem(menu, menuname, player, task, 4, 1,  slot, SteakGUI.convertMessage("&b펄미션 입력"), Material.PAPER, new String[]{SteakGUI.convertMessage("&b구매하게 될 펄미션을 입력합니다.")}));
        } else if(((String)edittask.getData()[0]).equals("item")) {
            setting.setItem(9, new ItemTaskItem(menu, menuname, player, task, 5, 1,  slot, SteakGUI.convertMessage("&b아이템 선택"), Material.EMERALD, new String[]{SteakGUI.convertMessage("&b구매하게 될 아이템을 손에서 선택합니다.")}));
        } else if(((String)edittask.getData()[0]).equals("exp")) {
            setting.setItem(9, new ItemTaskItem(menu, menuname, player, task, 6, 1,  slot, SteakGUI.convertMessage("&b아이템 선택"), Material.ENCHANTMENT_TABLE, new String[]{SteakGUI.convertMessage("&b구매하게 될 아이템을 손에서 선택합니다.")}));
