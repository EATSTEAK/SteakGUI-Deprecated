...
public class SellTaskEditor {
    public void show(Menu menu, Player player, String menuname, int slot, int task) {
        ...
        setting.setItem(46, new ItemTaskItem(menu, menuname, player, task, 13, 1,  slot, SteakGUI.convertMessage("&b작업 삭제"), Material.NETHER_BRICK_ITEM, new String[]{SteakGUI.convertMessage("&b작업을 삭제합니다.")}));
