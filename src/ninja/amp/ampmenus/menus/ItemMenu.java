...
public class ItemMenu {
    ...
    private static final MenuItem EMPTY_SLOT_ITEM = new StaticMenuItem(" ", new ItemStack(Material.THIN_GLASS, 1));
     ...
     * @param name   The name of the inventory.
     * @param size   The {@link ninja.amp.ampmenus.menus.ItemMenu.Size} of the inventory.
     * @param plugin The PluginLoader instance.
     */
    ...
    public void onInventoryClick(InventoryClickEvent event) {
            ...
            if (slot >= 0 && slot < size.getSize() && items[slot] != null) {
                ...
                ItemClickEvent itemClickEvent = new ItemClickEvent(event);
